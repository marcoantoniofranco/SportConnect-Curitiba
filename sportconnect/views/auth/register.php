        ...
        <form method="POST" action="index.php?url=auth/register">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="tel" class="form-control" id="phone" name="phone" placeholder="(41) 99999-9999" required>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-4">
              ...
              <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Digite novamente" required>
            </div>
          </div>
          ...
          <div class="text-center">
            <small class="text-muted">
              ...
              <a href="index.php?url=home/about" class="text-primary">Termos de Uso</a> e
              <a href="index.php?url=home/about" class="text-primary">Política de Privacidade</a>
            </small>
          </div>
        </form>
      </div>
